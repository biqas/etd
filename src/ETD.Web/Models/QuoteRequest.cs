...
public sealed class QuoteRequest
{
    ...
    /// <summary>
    /// Pipe-separated list of "service-slug::feature-text" entries selected on step 2.
    /// Replaces the per-service slider/parameter blocks. Submitted via a hidden InputText
    /// synced from checkboxes by client-side JS (Static SSR friendly).
    /// </summary>
    public string? SelectedFeaturesRaw { get; set; }

    /// <summary>Parsed selected features keyed by service slug. Populated in step 2 OnParametersSet.</summary>
